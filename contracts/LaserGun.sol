...
{ 
    ...
    function transfer(
        ...
        emit Shielded(recipientCommitment, senderShield.token, amount, 0);
    ...
    // View functions
    function getShieldInfo(bytes32 commitment) external view returns (
        bool exists,
        address token,
        uint256 amount,
        uint256 timestamp,
        ...
        return (currentShield.exists, currentShield.token, currentShield.amount, currentShield.timestamp, currentShield.spent);
    }
